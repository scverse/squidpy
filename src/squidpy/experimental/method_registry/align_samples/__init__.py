...
:data:`~squidpy.experimental.method_registry._families.ALIGN_SAMPLES`. It stays cheap --
...
from squidpy.experimental.method_registry.align_samples._stalign import fit_stalign
